...
class selectTypeCheckAttendance_page extends StatefulWidget{
  @override
  selectTypeCheckAttendance_pageState createState() => selectTypeCheckAttendance_pageState();
}

class selectTypeCheckAttendance_pageState extends State<selectTypeCheckAttendance_page>{
  ...
  void checkTypeButtonClicked(){
    if(typeSelected != ""){
      ...
      authController.goToSelectEmailToCheckPage(typeSelected.toString());
    }else{
