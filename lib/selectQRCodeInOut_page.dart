...
class selectQRCodeInOutPage extends StatelessWidget {
        ...
        body: Column(
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                MakeText(text: "Please select the QR Code Type: IN Or Out!", color: MyAppColorSetting.getContextTitleColor(), size:Dimensions.font20),
              ],
            )
          ),
          SizedBox(height: Dimensions.heihgt60,),
            ElevatedButton(onPressed:(){authController.showQRCodeForStaffIn();} , child: Text("Go To Staff In QR Code Page")), // go to let boss choose date to check
            SizedBox(height: Dimensions.heihgt15,),
            ElevatedButton(onPressed:(){authController.showQRCodeForStaffOut();} , child: Text("Go To Staff Out QR Code Page")), // go to let boss choose staff name to check 
          ],
        ),
