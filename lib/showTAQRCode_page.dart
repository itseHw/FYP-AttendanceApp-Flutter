...
class ShowTAQRCodeInPage extends StatefulWidget {
  @override
  showTaQRCodeInPageState createState() => showTaQRCodeInPageState();
}

class showTaQRCodeInPageState extends State<ShowTAQRCodeInPage>{
    ...
    return WillPopScope(
      ...
      body: Column(
        children:[
          ...
          Expanded(
              child:  QrImageView(
              data: qrCodeGenerator.generateQRCodedata("StaffIn"),
