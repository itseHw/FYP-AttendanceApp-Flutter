...
//For visitor check request record
class ShowVisitApprovePage extends StatelessWidget {
            ...
            return Card(
              child:ListTile(
                title:Column(mainAxisAlignment: MainAxisAlignment.start,
                  children: [
                    Text("VisitDate: " + authController.callBackVisitRecord[index].visitDate),
                    Text("VisitTime: " + authController.callBackVisitRecord[index].visitTime),
